...
export const iconos: { [key: string]: string } = {
  vue: "/src/components/icons/Vue.svg",
  vite: "/src/components/icons/Vite.svg",
  react: "/src/components/icons/React.svg",
  php: "/src/components/icons/Php.svg",
  tailwind: "/src/components/icons/Tailwind.svg",
  javascript: "/src/components/icons/JS.svg",
  css: "/src/components/icons/CSS.svg",
  html: "/src/components/icons/HTML.svg",
  mysql: "/src/components/icons/Mysql.svg",
  nodejs: "/src/components/icons/Nodejs.svg",
  express: "/src/components/icons/Express.svg",
  mongodb: "/src/components/icons/Mongo.svg",
  sequilize: "/src/components/icons/Sequelize.svg",
  vercel: "/src/components/icons/Vercel.svg",
  netlify: "/src/components/icons/Netlify.svg",
  laravel: "/src/components/icons/Laravel.svg",
  godaddy: "/src/components/icons/Godaddy.svg",
};
